<header  {{ $attributes->merge(['class' => 'relative z-10']) }}">
    <nav class="container flex items-center justify-between w-full h-40 px-12 mx-auto">
        ...
        <ul class="flex justify-end list-none header-list">
            ...
            <li><a class="transition-all duration-200 ease-in hover:underline" href="{{route('kids.paints')}}">Arte</a></li>
            <li><a class="transition-all duration-200 ease-in hover:underline" href="{{route('kids.stories')}}">Cuentos</a></li>
